...
class ViT(nn.Module):
    def __init__(self, *, image_size, image_patch_size, frames, frame_patch_size, num_classes, dim, depth, heads, mlp_dim, pool = 'cls', channels = 3, dim_head = 64, dropout = 0., emb_dropout = 0.):
        ...
        num_patches = (self.image_height // self.patch_height) * (self.image_width // self.patch_width) * (self.frames // self.frame_patch_size)
        patch_dim = channels * self.patch_height * self.patch_width * self.frame_patch_size
